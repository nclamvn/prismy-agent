...
init_code = '''
    def __init__(self):
        ...
        super().__init__(TransformationType.EDUCATION_MODULE)
...
if 'def __init__' not in content:
    content = re.sub(
        r'(class EducationModuleBuilder.*?""".*?""")',
        r'\1\n' + init_code,
        content,
        flags=re.DOTALL
    )
...
print("✅ Integrated LLM into education_module_builder.py")
