...
try:
    from src.ai_commander.enhanced_commander.production_claude_commander import ProductionClaudeCommander
    ...
    try:
        with st.spinner("Processing..."):
            if BACKEND_AVAILABLE:
                # Use real backend
                from src.infrastructure.ai_intelligence.intelligence_orchestrator import ProcessingRequest, ProcessingMode as PM
