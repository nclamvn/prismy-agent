...
try:
    from src.ai_commander.enhanced_commander.claude_commander import ClaudeCommander
    from src.infrastructure.content_transformation.video_dna_creator import VideoDNACreator, create_video_dna
...
"""
    ...
    if generate_button and script_content.strip():
        with st.spinner("🧬 Processing with PRISM Video DNA Engine..."):
            ...
            result = create_video_dna(script_content, duration)
